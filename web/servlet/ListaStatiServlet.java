...
@WebServlet("/ListaStatiServlet")
public class ListaStatiServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

		try {
			request.setAttribute("listaStatiAttribute",
					MyServiceFactory.getStatoServiceInstance().listAll());
		} catch (Exception e) {
			e.printStackTrace();
