		            ...
		            <table class='table table-striped ' >
		                ...
		                <tbody>
		                    ...
		                    <tr >
		                        ...
		                        <td>
									<a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="PrepareEditStatoServlet?idStato=<%=item.getId() %>">Edit</a>
									<a class="btn btn-outline-danger btn-sm" href="PrepareDeleteStatoServlet?idStato=<%=item.getId() %>">Delete</a>
								</td>
		                    </tr>
		                    <% } %>
		                </tbody>
